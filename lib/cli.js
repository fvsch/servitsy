...
export function helpPage() {
	...
	/** @type {OptionName[]} */
	const optionsOrder = ['help', 'version', 'host', 'port', 'headers', 'cors', 'ext', 'dirFile', 'dirList', 'exclude'];
	...
	return [
		section(
			`${style('servitsy', 'magentaBright bold')} — Start a HTTP server for a directory of static files`,
		),
		section('USAGE', [
